...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.infinitystudios.tcpip.R.layout.activity_main);

        mTxtMessage = findViewById(com.infinitystudios.tcpip.R.id.txtMessage);
        mEditMessage = findViewById(com.infinitystudios.tcpip.R.id.editMessage);
